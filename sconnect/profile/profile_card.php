<span class="left_pane">
	<div class="card container">
		...
		if($_SESSION['profile_image_path']==null) {
			$_SESSION['profile_image_path'] = 'profile.png';
		}
		echo '<img src="'.$_SESSION['profile_image_path'].'" alt="Display Image" style="width: 100%">';
		?>
		...
		<form method="post" action="resume_upload.php" enctype="multipart/form-data">
			...
			<input type="submit" name="upload_resume" value="Upload"/>
		</form>
	</div>
</span>
